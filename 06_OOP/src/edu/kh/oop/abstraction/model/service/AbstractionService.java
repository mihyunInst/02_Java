...
public class AbstractionService {
	...
	public void ex1() {
		...
		*/
		...
		mihyun.setName("조미현");
		mihyun.setGender('여');
		mihyun.setpNo("200416-4234567");
		mihyun.setPhone("010-1234-1234");
		mihyun.setAddress("서울시 중구 남대문로 120 그레이츠청계 3층 E강의장");
		mihyun.setAge(5);
		
		System.out.println("====================================");
		
		System.out.println("mihyun의 name : " + mihyun.getName() );
		System.out.println("mihyun의 gender : " + mihyun.getGender() );
		System.out.println("mihyun의 pNo : " + mihyun.getpNo() );
		System.out.println("mihyun의 address : " + mihyun.getAddress() );
		System.out.println("mihyun의 phone : " + mihyun.getPhone() );
		System.out.println("mihyun의 age : " + mihyun.getAge() );
